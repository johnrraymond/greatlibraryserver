...
def test_timecube(heros, timecube, loot):
    ...
    timecube.castAO(GAZ, GAZ, RENNLY, {'from': accounts[0].address})
    LOG.info("Gaz casts Arcane Orb on himself twice and Rennly once.")

    ## Rennly activates the arcane orb attacking gaz with it.
    timecube.activateAO(RENNLY, GAZ, ARCANE_ORB, 1, {'from': accounts[0].address})
