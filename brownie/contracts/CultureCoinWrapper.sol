...
contract CultureCoinWrapper is ERC20, ERC20Burnable {
    ...
    function generate(string memory _meme) public payable {		// await debugPayableFunction02("generate", priceEncoded, oferingId, "You have now generated a new coin under yours.");
